...
<ParamField path="/hubbly worlds <subcommand>" type="subcommand">
  Control which worlds have Hubbly features enabled or disabled.
  
  **Permission:** `hubbly.command.worlds`
</ParamField>
...
<ParamField path="/hubbly pv <show|hide>" type="subcommand">
  Toggle player visibility for the command sender.
  
  **Permission:** `hubbly.command.playervisibility`
</ParamField>
...
<ParamField path="/hubbly movement <mode>" type="subcommand">
  Change the player's active movement enhancement mode.
  
  **Permission:** `hubbly.command.movement`
</ParamField>
...
<ParamField path="/hubbly debug" type="subcommand">
  Toggle debug mode to see detailed plugin information in console.
  
  **Permission:** `hubbly.command.debug`
</ParamField>
